...
fun <T> GenericSearchScreen(
    ...
    filterChips: List<com.mytask.core.presentation.screens.SearchFilterChip> = emptyList(),
    onFilterClick: (com.mytask.core.presentation.screens.SearchFilterChip) -> Unit = {},
